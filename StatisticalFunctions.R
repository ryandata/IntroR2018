# Statistical Functions R code for
# Introduction to R workshop
# Ryan Womack, rwomack@rutgers.edu
# 2018-10-06 version

###################################################
### code chunk number 1: getwd()
###################################################
getwd()
getwd
# Getwd()
...
###################################################
### code chunk number 2: Comment (eval = FALSE)
###################################################
## # this is a comment


###################################################
### code chunk number 3: setwd (eval = FALSE)
###################################################
## setwd("pathname")

###################################################
### code chunk number 4: 2+2
###################################################
2+2


###################################################
### code chunk number 5: 2+2 is 5
###################################################
...
###################################################
### code chunk number 6: install packages (eval = FALSE)
###################################################
...
###################################################
### code chunk number 7: samples and distributions
###################################################
sample(1:100,10)
rnorm(10)
...
###################################################
### code chunk number 19: load data and summarize
###################################################
data(cystfibr)
?cystfibr
summary(cystfibr)
...
###################################################
### code chunk number 20: attaching a dataset
###################################################
mean(cystfibr$age)
...
###################################################
### code chunk number 21: descriptive statistics
###################################################
sd(age)
var(age)
median(age)
...
###################################################
### code chunk number 22: histogram
###################################################
hist(age)


###################################################
### code chunk number 23: by
###################################################
by(cystfibr, cystfibr["sex"],summary)


###################################################
### code chunk number 24: table
###################################################
table(sex)
table(age,sex)

###################################################
### code chunk number 25: t test
###################################################
t.test(pemax)
mean(pemax)
t.test(pemax, mu=100)
...
###################################################
### code chunk number 26: 2 sample t test
###################################################
t.test(pemax~sex)


###################################################
### code chunk number 27: linear regression
###################################################
lm(pemax~tlc)


###################################################
### code chunk number 28: linear regression
###################################################
...
###################################################
### code chunk number 29: regression through the origin
###################################################
lm(pemax~ tlc -1)


###################################################
### code chunk number 30: predict
###################################################
predict(regoutput)


###################################################
### code chunk number 31: anova
###################################################
anova(regoutput)


###################################################
### code chunk number 32: correlation
###################################################
cor(height,weight)
...
###################################################
### code chunk number 33: plot
###################################################
plot(regoutput, pch=3)


###################################################
### code chunk number 34: multiple regression
###################################################
